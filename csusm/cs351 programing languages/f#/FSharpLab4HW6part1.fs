...
let main argv =
    ...
    //I designed some Lab questions similar to Koans for you to practice more. Question banks avaliable on Internet are too hard for beginnners. I cannot use any book related question banks as well, otherwise I have to set this book as a required textbook and you would need to buy it.
    ...
    //#########################
    //Goal: fill in blanks to get every question run. Counts as 6pt HW. (PythonLab2 is the other 4pt)
    //All questions should work together. If not, update variable names. 
    ...
    //Why would this work?
    //Try it out: If you do "let add2 a b = x +y" in Q8(Q6?) instead, will it work? Why? No becuase 3+4 will be ocmputed and not carried over for adding again
    //Try it out: If you do "add2 (add2 a b) (add2 a b)" in Q8(Q6?) instead, will it work? Why? no a b doesnt exist in the context
    ...
    testEqual 10 10
    printf "Q14-2 ..."
    testEqualNew (10, 10)//needs to be tuple
    printf "Q14-3 ..."
    testEqualNew (10,10)
    ...
    let testEqual3 tup3 = 
        match tup3 with
        | (a,b,c) when a=b && b=c -> printfn "TestSuccess!"
        | (a,b,c) -> printfn "Fail!"
